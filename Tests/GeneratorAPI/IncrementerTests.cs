...
namespace Tests.GeneratorAPI {
    ...
    internal class IncrementerTests {
        ...
        public void Int_MinValue_Does_Not_Throw() {
            var result = Generator.Incrementer(int.MinValue)
                .Take(500);
        ...
        public void Start_Below_Int_MinValue_Throws() {
            ...
            var result = Generator.Incrementer(start - 1)
                .Take(1);
        ...
        public void Start_Int_MaxValue_Throws() {
            var result = Generator.Incrementer(int.MaxValue)
                .Take(500);
            Assert.Throws<OverflowException>(() => result.ToArray());
        }
        ...
        public void Start_Minus_Twenty() {
            var result = Generator.Incrementer(-20)
                .Take(500);
        ...
        public void To_Int_Max_Value() {
            ...
            var result = Generator.Incrementer(start)
                .Take(500);
